...
class SpeedAndDistanceEstimator:
    """Estimates player speed and distance traveled from tracking data."""

    def __init__(self):
        """Initialize with default frame window and frame rate."""
        self.frame_window = 5
        self.frame_rate = 24

    def add_speed_and_distance_to_tracks(self, tracks):
        """Add speed and cumulative distance to tracked players."""
        total_distance = {}
