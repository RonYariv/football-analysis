"""
Main script to process video for player tracking, team assignment, ball possession,
camera movement compensation, speed and distance calculation, and annotated output.
"""
...
def main():
    video_frames = read_video('input_videos/first.mp4')
    ...
    # ------------------------------
    # Assign team colors and player teams
    # ------------------------------
    ...
    # ------------------------------
    # Assign ball possession to players and calculate team ball control
    # ------------------------------
    ...
    for frame_num, player_track in enumerate(tracks['players']):
        ...
        if assigned_player is not None:
            ...
            # Skip adding for the first frame
            if not team_ball_control or team_ball_control[-1] is None:
                continue
            # If no player is assigned, use the previous frame's team control
